<?php
//Add theme setup
if ( ! function_exists( 'mosselfmade_setup' ) ) :
	function mosselfmade_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => esc_html__('Main Menu', 'mosselfmade'),
			'mobilemenu' => esc_html__('Mobile Menu', 'mosselfmade'),
		));
...
add_action( 'after_setup_theme', 'mosselfmade_setup' );